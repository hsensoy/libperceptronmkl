...
eparseError_t showStats(Perceptron_t p){
    ...
    switch(p->type){
        case KERNEL_PERCEPTRON:
            return showStatsKernelPerceptron((KernelPerceptron_t) (p->pDeriveObj));
        case SIMPLE_PERCEPTRON:
            return showStatsSimplePerceptron((SimplePerceptron_t) (p->pDeriveObj));
